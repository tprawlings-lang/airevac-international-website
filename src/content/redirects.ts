...
export const legacyRedirects: RedirectRule[] = [
  ...
  // Case-manager content is the hospital referral path.
  to('/case-managers', '/partners/hospitals'),
  to('/case-managers/request-promotional-items', '/partners/hospitals'),
  ...
  ].map((island) => to(`/locations/${island}`, '/partners/cruise')),
  ...
  to(
    '/difference-between-air-ambulance-and-commercial-airline-medial-escorts',
    '/services/commercial-medical-escort',
  ),
